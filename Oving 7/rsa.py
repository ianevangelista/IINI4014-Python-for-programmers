...
def findQandP(n):
    ...
    for primeP in primes:
        for primeQ in primes:
            if(((primeP*primeQ) == 100127)):
                print("q:", primeQ, "p:", primeQ)
